...
<template>
    <section class="mb-8">
        <div class="mt-header">
            <div class="grid gap-10 md:grid-cols-[minmax(0,1.1fr)_minmax(0,1fr)] lg:gap-16 h-full">
                <div class="grid gap-4 md:gap-6 relative 
                    ...
                    <div class="order-2 md:order-1" :style="{ maxHeight: thumbsMaxHeight }">
                        <Swiper 
                            class="swiper--thumbs !h-full w-full" 
                            :modules="modules"
                            :space-between="8" 
                            :free-mode="true" 
                    ...
                    <div class="order-1 md:order-2">
                        <div class="relative md:h-full">
                            <Swiper 
                                ...
                                <SwiperSlide v-for="(image, index) in images" :key="image.id || index">
                                    <div class="aspect-3/2 bg-gray-100 rounded-lg overflow-hidden" style="max-height: clamp(200px, 60vh, 500px);">
                                        <img 
                                            :src="image.url" 
                                            :alt="image.alt || `產品圖片 ${index + 1}`"
                                            class="w-full h-full object-cover"
                                            @load="updateThumbsHeight">
                                    </div>
                                </SwiperSlide>
                            </Swiper>
